...
const bio = ref({
  ...
  about: `I am a current student at South Texas College, currently in the CITP program and expect to graduate this May of 2025. I am also in the CITP Cybsecurity Clinic under Professor Nicholas Hinojosa, where I have been able to gain hands-on experience in the field of cybersecurity. I am passionate about technology and am always eager to learn new skills and take on new challenges.`,
  skills: ['Networking', 'Team Skills', 'Active Directory', 'Cybersecurity', 'Home Servers'],
  email: 'christopherr308@gmail.com',
    ...
    >
      ...
      <div>
        ...
        <a
          ...
          class="group hover:bg--600 inline-flex items-center gap-2 rounded-xl bg-blue-500 px-6 py-3 font-medium text-white shadow-lg shadow-blue-500/30 transition-all duration-200 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/40 active:scale-95"
        >
          <svg
            data-slot="icon"
            fill="none"
